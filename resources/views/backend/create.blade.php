            ...
            <div class="p-5 bg-gray-600 rounded-md">
                ...
                <form action="{{ route('fast_url.create') }}" method="POST">
                    ...
                    <input type="text" name="orignal_url" value="{{ old('orignal_url') }}"
                        class="py-3 px-3 bg-transparent border  w-full mt-2 outline-none h-10 rounded mb-5 @error('orignal_url') border-red-300
                        @enderror"
                    ...
                    <input type="text" name="title" value="{{ old('title') }}"
                        class="w-1/2 h-10 px-3 py-3 mt-2 bg-transparent border rounded outline-none"
